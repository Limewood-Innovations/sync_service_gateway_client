...
class KontoauszugCreate(BaseModel):
    """
    KontoauszugCreate
    """ # noqa: E501
    bukrs: StrictInt
    customer_number: StrictInt = Field(alias="customerNumber")
    contract_number: StrictStr = Field(alias="contractNumber")
    var_date: date = Field(alias="date")
    jira_ticket_number: StrictStr = Field(alias="jiraTicketNumber")
    mode: StrictStr
    __properties: ClassVar[List[str]] = ["bukrs", "customerNumber", "contractNumber", "date", "jiraTicketNumber", "mode"]
