...
class IHCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["jira_ticket_number", "notif_type", "short_text", "long_text", "func_loc", "reported_by", "notif_date", "plan_group", "partner_number", "plan_plant", "partner_role", "set_active", "transaction_id", "state", "creation_date", "last_updated"]
