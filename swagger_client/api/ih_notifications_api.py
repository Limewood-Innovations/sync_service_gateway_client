...
class IHNotificationsApi(object):
    ...
    def increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put(self, transaction_id, retry_count, **kwargs):  # noqa: E501
        """Increment Ihcreate Retry Count  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put(transaction_id, retry_count, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object transaction_id: (required)
        :param object retry_count: (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put_with_http_info(transaction_id, retry_count, **kwargs)  # noqa: E501
        else:
            (data) = self.increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put_with_http_info(transaction_id, retry_count, **kwargs)  # noqa: E501
            return data

    def increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put_with_http_info(self, transaction_id, retry_count, **kwargs):  # noqa: E501
        """Increment Ihcreate Retry Count  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put_with_http_info(transaction_id, retry_count, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['transaction_id', 'retry_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'transaction_id' is set
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put`")  # noqa: E501
        # verify the required parameter 'retry_count' is set
        if ('retry_count' not in params or
                params['retry_count'] is None):
            raise ValueError("Missing the required parameter `retry_count` when calling `increment_ihcreate_retry_count_ihcreate_transaction_id_retry_count_put`")  # noqa: E501
        ...
        if 'retry_count' in params:
            query_params.append(('retry_count', params['retry_count']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ihcreate/{transaction_id}/retry_count', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_ihcreate_state_ihcreate_transaction_id_state_put(self, transaction_id, state, **kwargs):  # noqa: E501
        """Update Ihcreate State  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ihcreate_state_ihcreate_transaction_id_state_put(transaction_id, state, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_ihcreate_state_ihcreate_transaction_id_state_put_with_http_info(transaction_id, state, **kwargs)  # noqa: E501
        else:
            (data) = self.update_ihcreate_state_ihcreate_transaction_id_state_put_with_http_info(transaction_id, state, **kwargs)  # noqa: E501
            return data

    def update_ihcreate_state_ihcreate_transaction_id_state_put_with_http_info(self, transaction_id, state, **kwargs):  # noqa: E501
        """Update Ihcreate State  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ihcreate_state_ihcreate_transaction_id_state_put_with_http_info(transaction_id, state, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['transaction_id', 'state']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_ihcreate_state_ihcreate_transaction_id_state_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'transaction_id' is set
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `update_ihcreate_state_ihcreate_transaction_id_state_put`")  # noqa: E501
        # verify the required parameter 'state' is set
        if ('state' not in params or
                params['state'] is None):
            raise ValueError("Missing the required parameter `state` when calling `update_ihcreate_state_ihcreate_transaction_id_state_put`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ihcreate/{transaction_id}/state', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
