...
class OrderDocumentCreateCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["parent_transaction_id", "jira_ticket_number", "notif_number", "osid_ticket_object", "osid_order_document"]
