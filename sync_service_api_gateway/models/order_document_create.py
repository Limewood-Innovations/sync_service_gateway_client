...
class OrderDocumentCreate(BaseModel):
    ...
    """ # noqa: E501
    parent_transaction_id: StrictStr = Field(description="The parent transaction ID from the IH notification create process.")
    ...
    osid_ticket_object: StrictInt = Field(description="The OSID number of the ticket object.")
    osid_order_document: StrictInt = Field(description="The OSID number of the order document.")
    transaction_id: Optional[StrictStr] = Field(default=None, description="A unique transaction ID, automatically generated for the order document creation transaction.")
    ...
    __properties: ClassVar[List[str]] = ["parent_transaction_id", "jira_ticket_number", "notif_number", "osid_ticket_object", "osid_order_document", "transaction_id", "state", "retry_count", "creation_date", "last_updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "osid_ticket_object": obj.get("osid_ticket_object"),
