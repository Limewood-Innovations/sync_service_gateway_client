...
class IHNotificationUpdateJiraClose(BaseModel):
    """
    ...
    """ # noqa: E501
    parent_transaction_id: StrictStr = Field(description="The parent transaction ID from the IH notification close process.")
    ...
    transaction_id: Optional[StrictStr] = Field(default=None, description="A unique transaction ID, automatically generated for the Jira closure transaction.")
