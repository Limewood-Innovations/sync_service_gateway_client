...
class PortalBPIbanMail(BaseModel):
    """
    ...
    """ # noqa: E501
    parent_transaction_id: StrictStr = Field(description="The parent transaction ID for the main transaction.")
    bpnr: StrictStr = Field(description="The Business Partner Number.")
    iban: StrictStr = Field(description="The IBAN (International Bank Account Number) for the business partner.")
    transaction_id: Optional[StrictStr] = Field(default=None, description="Unique ID for this transaction, generated as a UUID.")
    ...
    __properties: ClassVar[List[str]] = ["parent_transaction_id", "bpnr", "iban", "transaction_id", "state", "retry_count", "creation_date", "last_updated"]
