...
class VersionApi:
    ...
    def version_get_version(
        ...
        _param = self._version_get_version_serialize(
    ...
    @validate_call
    def version_get_version_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def version_get_version_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _version_get_version_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
